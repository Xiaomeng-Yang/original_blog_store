...
secret_id = 'AKIDv4DLNZdT6VeZGjzERUK0YsdJp6AEBwVs'     # 替换为用户的secret_id
secret_key = 'INEsLcgokU0KSQCl7LRO9i4TsLfosBLO'     # 替换为用户的secret_key
...
galleries = []
json_name = "galleries.yml"    # 图片数据文件名称
bucket_name = "blog-photos-1305943987"      # 腾讯COS存储桶名称
